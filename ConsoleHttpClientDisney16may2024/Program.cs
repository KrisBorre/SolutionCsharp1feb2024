...
namespace ConsoleHttpClientDisney16may2024
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            dynamic newtonsoft_response = JsonConvert.DeserializeObject<dynamic>(resp);

            //await Console.Out.WriteLineAsync(newtonsoft_response.info); // Exception

            //await Console.Out.WriteLineAsync(newtonsoft_response.data); // Exception
