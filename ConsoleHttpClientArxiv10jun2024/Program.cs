...
namespace ConsoleHttpClientArxiv10jun2024
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            //list.Add("paradigm+induced+changes+scientific+perception");
            //list.Add("Atwood+machine");
            //list.Add("crisis+emergent+paradigms+theory+change");
            //list.Add("competition+between+views+nature+early+stages+scientific+development");
            //list.Add("Michel+Foucault+Thomas+Kuhn");
            //list.Add("Leon+Foucault+Thomas+Kuhn");
            //list.Add("exemplars+normal+science");
            //list.Add("articulation+scientific+theories");
